...
//               <img className="img--carteira" src="/img/carteira.svg" alt="carteira--pagamento"/>
//               <p>PAGAMENTO</p>
//             </div>
...
//                     <p className="nome--cpf">Paula Silva <br/>000.000.000-00</p>
//                     <br/>
//                     <p className="endereco">Rua dos Bobos, Nº 000 <br/> Bairro Travessa 1 <br/>Cidade-ES <br/>CEP 00000-000</p>
//                     <button className="dados--cadastrais">EDITAR DADOS CADASTRAIS</button>
//                   </div>
//                 </div>
//               </div>
...
//                       <img className="img--cartao" src="/img/cartao.svg" alt="imagem cartão"/>
...
//                     <div className="div--form">
//                       <label for="numero--cartao">Numero do cartão de crédito</label>
//                       <input
//                       type="text"
//                       id="numero--cartao"
...
//                       <button
//                       type="submit"
//                       className="confirmar--cartao">CONFIRMAR CARTÃO</button>
//                     </div>
...
//                       <p><strong>SUBTOTAL</strong> <br/> (X produtos)</p>
//                         <p>R$ 00,00</p>
//                       </div>
//                       <br/>
//                       <div className="frete">
