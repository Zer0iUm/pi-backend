  ...
  return (
    <>
        ...
        <section id={styles.img_produto}>
          <div id={styles.produto_mini}>
            <img
              ...
              style={activeImage1 ? { opacity: ".5" } : { opacity: "1" }}
              onClick={() => {
                handleChange(`http://localhost:3000/img/${product.image}`);
                {
            ...
            <img
              ...
              style={activeImage2 ? { opacity: ".5" } : { opacity: "1" }}
              onClick={() => {
                handleChange("http://localhost:3000/img/double.png");
                {
            ...
            <img
              ...
              style={activeImage3 ? { opacity: ".5" } : { opacity: "1" }}
              onClick={() => {
                handleChange("http://localhost:3000/img/american pale ale.png");
                {
                  setActiveImage1(false);
                  setActiveImage2(false);
          ...
          <img alt="Imagem principal" src={displayImage} id={styles.display} />
        </section>
              ...
              onClick={() => {
                setQuantidade((prevQuantidade) => {
                  if (quantidade <= 1) setQuantidade(1);
                    ...
                    const updatedQuantidade = prevQuantidade - 1;
      ...
      <section id={styles.recomendacao}>
        <h2 className={styles.subtitulo}>QUEM VIU ESSE PRODUTO TAMBÉM VIU</h2>
        <hr className={styles.divisao} />
        <ul className="produtos__container">
          {Array.from({ length: 4 }, (item, index) => {
            const iRandom = Math.floor(Math.random() * allProducts.length);
            return (
              <li className="produto__container">
                ...
                >
                  ...
                  <div className="produto__conteudo">
                    <p className="produto__nome">{product.name}</p>
                    {/* <p className='produto__descricao'>
											{product.description}
										</p> */}
                    <p className="produto__valor">{product.price}</p>
                  </div>
                </Link>
              </li>
            );
