          ...
          <div className="filtro--cerveja--completo">
            <div className="filtro--completo">
              ...
              <section>
                <div className="american--pale--ale">
                  <input
                    ...
                    checked
                  />
                  <label for="american-pale--ale">American Pale Ale</label>
                </div>

                <div className="double--ipa">
                  <input type="checkbox" id="double--ipa" name="double--ipa" />
                  <label for="double--ipa">Double IPA</label>
                </div>

                <div className="brown--ale">
                  <input type="checkbox" id="brown--ale" name="brown--ale" />
              ...
              <section>
                ...
                <div className="seis">
                  <input type="checkbox" id="seis" name="seis" />
                  <label for="seis">6%</label>
                </div>

                <div className="dez">
                  <input type="checkbox" id="dez" name="dez" />
              ...
              <section>
                ...
                <div className="oitenta">
                  <input type="checkbox" id="oitenta" name="oitenta" />
                  ...
                  <li className="produto__container">
                    ...
                    >
                      ...
                      <div className="produto__conteudo">
                        ...
                        <p className="produto__descricao">{product.type}</p>
                        <p className="produto__valor">R${product.price}</p>
                      </div>
                    </Link>
                  </li>
                ))}
